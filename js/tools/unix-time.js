(function(){
  ...
  window.UT={
    fromUnix(){let v=parseInt(document.getElementById('ut-unix').value);if(isNaN(v))return;let d=new Date(v*1000);document.getElementById('ut-utc').value=d.toUTCString();document.getElementById('ut-local').value=d.toLocaleString();},
